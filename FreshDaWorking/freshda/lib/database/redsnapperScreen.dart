...
class RedSnapper extends StatefulWidget {
  const RedSnapper({Key? key}) : super(key: key);

  @override
  State<RedSnapper> createState() => _RedSnapperState();
}
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              child: ClipRRect(
                                child: Image.asset('assets/RedSnapperFull.png',
                            ...
                            Container(
                              ...
                              padding: EdgeInsets.all(20),
                              height:
                                  MediaQuery.of(context).size.height * 0.70 / 5,
                              width: MediaQuery.of(context).size.width,
                              decoration: BoxDecoration(
                                color: grayButton,
                                borderRadius: BorderRadius.circular(20),
